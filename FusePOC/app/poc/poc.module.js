...
define(["require", "exports", './poc.controller', './poc.config', './poc.component', '../auto/auto.module', '../spul/spul.module', '../shared/shared.component', '../generic/generic.directive', './poc.service', 'angular', 'angular-route', 'angular-resource'], function (require, exports, poc_controller_1, poc_config_1, poc_component_1, auto_module_1, spul_module_1, shared_component_1, generic_directive_1, poc_service_1) {
    ...
    angular.module('PocModule', ['ngRoute',
        ...
        .factory('pocService', function ($resource) { return new poc_service_1.POCService($resource); })
